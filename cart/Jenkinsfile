...
pipeline {
    ...
    stages  {
        ...
        stage("build-image") {
            ...
            steps {
                sh 'docker build . -t enablementprojects/interns-iware-carts:latest'
            }
        }
        ...
        stage("push-image") {
            ...
            steps {
                sh 'docker push enablementprojects/interns-iware-carts'
            }
 	    }
        ...
        stage("deploy-image") {
            ...
            steps {
                sh 'kubectl rollout restart deployment/interns-iware-carts  --namespace=intern-2022'
            }
         }
    }
